...
export function mergeAxisAligned(segments) {
    ...
    for (let i = 0; i < segments.length; i += 6) {
        const x1 = segments[i]; const y1 = segments[i + 1]; const z1 = segments[i + 2];
        const x2 = segments[i + 3]; const y2 = segments[i + 4]; const z2 = segments[i + 5];
        ...
        let axis; let key; let lo; let hi;
