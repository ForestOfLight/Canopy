...
describe('AbilityRule', () => {
    ...
    it('should use a custom action item if provided', () => {
        const customArrowRuleData = { ...testRuleData, identifier: 'customArrowRule' };
        const customArrowAbility = new AbilityRule(customArrowRuleData, { slotNumber: 1, actionItem: 'minecraft:other_item' });
